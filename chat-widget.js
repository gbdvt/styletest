  ...
  (function() {
      ...
      const styles = `
        ...
        .my-chat-widget .typing-indicator {
          display: flex;
          gap: 4px;
          padding: 12px 16px;
          margin: 8px 0;
        ...
        .my-chat-widget .typing-dot:nth-child(1) { animation-delay: 0s; }
        .my-chat-widget .typing-dot:nth-child(2) { animation-delay: 0.2s; }
        .my-chat-widget .typing-dot:nth-child(3) { animation-delay: 0.4s; }
    ...
    addNextChar();
      ...
      async function startNewConversation() {
        ...
        try {
          ...
          const initialGreeting = "Hi! I'm your AI assistant. How can I help you today?";
          const greetingDiv = document.createElement('div');
          greetingDiv.className = 'chat-message bot';
          greetingDiv.textContent = '';
          messagesContainer.appendChild(greetingDiv);
          await streamText(initialGreeting, greetingDiv);
          ...
          if (responseData && responseData.output && responseData.output.trim()) {
            ...
            await streamText(message, botMessageDiv);
          }
        } catch (error) {
      ...
      async function sendMessage(message) {
        ...
        try {
          ...
          // Stream the response
          const message = Array.isArray(data) ? data[0].output : data.output;
          await streamText(message, botMessageDiv);
        } catch (error) {
      ...
      const whatsappBtn = chatContainer.querySelector('.whatsapp-btn');
      whatsappBtn.addEventListener('click', () => {
        // Replace this number with your WhatsApp business number
        const phoneNumber = '33766335709';
